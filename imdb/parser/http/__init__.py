...
class IMDbHTTPAccessSystem(IMDbBase):
    ...
    def get_movie_reviews(self, movieID):
        ...
        p = 0
        while self.driver.find_elements_by_css_selector('.ipl-load-more__button') and not self.driver.find_elements_by_css_selector('.ipl-load-more__button--hidden'):
            print(self.driver.find_elements_by_css_selector('.ipl-load-more__button') and not self.driver.find_elements_by_css_selector('.ipl-load-more__button--hidden'))
